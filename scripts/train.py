...
# CUDA_VISIBLE_DEVICES=6 xvfb-run -a -s "-screen 0 1920x1080x24" python scripts/eval.py task=turn_tap snapshot=exp_local/fractal/rlbench_turn_tap_20260511021924/checkpoints/fractal_50000.pt method=fractal env.renderer=opengl3